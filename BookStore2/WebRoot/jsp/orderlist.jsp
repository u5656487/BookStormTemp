			...
			<tr>
				...
				<td><div style="text-align:right; margin:5px 10px 5px 0px">
						<a href="jsp/index.jsp">首页</a>&nbsp;&nbsp;&nbsp;&nbsp;&gt;&nbsp;&nbsp;&nbsp;<a
							href="jsp/myAccount.jsp">&nbsp;我的帐户</a>&nbsp;&nbsp;&nbsp;&nbsp;&gt;&nbsp;&nbsp;&nbsp;&nbsp;订单查询
					</div>


					<table cellspacing="0" class="infocontent">
						<tr>
							<td style="padding:20px"><p><font style="color:#A3B6E6; " size="3px">欢迎${user.username }光临商城！</font></p>
								<p>
									<font style="color:green; " size="5px">您一共有${listnum}个订单</font>
								</p>
						...
						<c:forEach items="${orderList }" var="order" varStatus="vs">
									<tr>
										<td bgcolor="#A3E6DF" class="tableopentd01">${order.id }</td>
										<td bgcolor="#A3D7E6" class="tableopentd01">${user.username}</td>
										<td bgcolor="#A3B6E6" class="tableopentd01">未支付</td>
									</tr>
						</c:forEach>		
								</table>
							</td>
