		...
		<table width="100%" border="0" cellspacing="0">
			<tr>
				...
				<td><div style="text-align:right; margin:5px 10px 5px 0px">
					...
					<form id="orderForm" action="${pageContext.request.contextPath }/cart/orderList" method="post">
												...
												<table cellspacing="1" class="carttable">
													<tr>
														<td style="text-align:right; padding-right:40px;"><font
															style="color:#FF0000">合计：&nbsp;&nbsp;${totals}元</font></td>
													</tr>
												</table>
												<p>
													收货地址：<input name="receiverAddress" type="text" value="${user.address}"
													...
													<br /> 联系方式：<input type="text" name="receiverPhone"
														value="${user.phone}" style="width:150px" />&nbsp;&nbsp;&nbsp;&nbsp;
												</p>
												<hr />
												</td>
										</tr>
